...
namespace Globals
{
	...
	extern inline std::string EUWebhook = "webhook url";
	extern inline std::string NAWebhook = "webhook url";
	...
	extern inline bool bAllowRebootPlayer = false;
	extern inline bool bRemoveRebootFromPlayerName = false; // buggy
	...
	extern inline std::string Bote = "backend name"; //Your backend name (Has to be the same one as in .env)
